        ...
        <div className="xl:flex xl:items-start xl:px-6 xl:py-8 xl:space-x-reverse xl:space-x-[55px]">
          <section className="p-6 space-y-5 xl:order-2 xl:p-0 xl:space-y-5 xl:w-1/2">
            <div className="space-y-3 flex flex-col items-start justify-center xl:flex-row xl:space-x-7 xl:space-y-0 xl:justify-start">
              <h2 className="text-black text-3xl font-bold xl:w-full">Tipo</h2>

              <p className="text-base text-black xl:w-full">
                Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aliquam
                sit amet congue metus. Donec ut enim placerat, maximus ipsum
                quis, laoreet neque.
              </p>
            </div>
            ...
            <div className="space-y-3 flex flex-col items-start justify-center xl:flex-row xl:space-x-7 xl:space-y-0 xl:justify-start">
              <h2 className="text-black text-3xl font-bold xl:w-full">Etapa</h2>
            ...
            <div className="space-y-3 flex flex-col items-start justify-center xl:flex-row xl:space-x-7 xl:space-y-0 xl:justify-start">
              <h2 className="text-black text-3xl font-bold xl:w-full">Local</h2>
            ...
            <div className="space-y-3 flex flex-col items-start justify-center xl:flex-row xl:space-x-7 xl:space-y-0 xl:justify-start">
              ...
              <p className="text-base text-black xl:w-full">
                Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aliquam
                sit amet congue metus. Donec ut enim placerat, maximus ipsum
                quis, laoreet neque. Pellentesque laoreet malesuada nisl id
                rutrum. Nulla euismod commodo tristique. Interdum et malesuada
                fames ac ante ipsum primis in faucibus. Morbi lacinia
                sollicitudin massa, quis eleifend ex malesuada ut. Praesent in
                eros eget dolor efficitur accumsan. Proin laoreet pellentesque
                viverra. Aliquam erat volutpat. Curabitur diam lectus, euismod
                nec massa id, eleifend tempus nulla. Nulla vel lobortis nibh.
                Nam molestie neque quis justo pretium, eu pretium orci
                fermentum. Donec varius gravida elementum. Mauris ligula metus,
                rutrum vel urna id, vestibulum suscipit nisi. Suspendisse
                laoreet urna augue, tincidunt congue metus maximus non.
              </p>
            </div>
          </section>
